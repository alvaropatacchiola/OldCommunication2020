...
Public Class query
    ...
    Public Function aggiorna_strumento_value29(ByVal value_29 As String, ByVal identificativo As String, ByVal id_485_temp As Integer) As Integer
        ...
        Return righe_aggiornate
    End Function
    Public Function get_strumenti_all(ByVal identificativo As String) As strumenti_db.strumentiDataTable
        'strimenti_db.Connection = objConn
        Try
    ...
    Public Function aggiorna_ip(ByVal ip_number As String, ByVal codice As String, ByVal differrenza_minuti As Long)
        ...
        End Try
    End Function
    Public Function get_ip(ByVal ip_number As String) As ip_list.ip_listDataTable
        'ip_puntatore.Connection = objConn
        Return ip_puntatore.GetData(ip_number)
    End Function
    Public Function get_ip_config(ByVal codice As String) As ip_list.ip_listDataTable
        'ip_puntatore.Connection = objConn
        Return ip_puntatore.GetData_config(codice)
    End Function

    Public Function valore_mail(ByVal codice_mail As String) As mail.impianto_newDataTable
    ...
    Public Function log_ldlg(ByVal identificativo As String, ByVal id_strumento As String, ByVal data As Date, _
        ...
        If count_row = 0 Then
            ...
            If count_row_ins > 0 Then
                If lettura_top10.Count > 0 Then
                    lettura_top10.RemoveAt(0) ' tolgo un elemento
                End If
    ...
    Public Function log_ltb(ByVal identificativo As String, ByVal id_strumento As String, ByVal data As Date,
                                ByVal valore_ch1 As Single, ByVal valore_ch2 As Single, ByVal valore_temperatura As Single,
                                ByVal flusso As Boolean,
                                ByVal lev_hcl As Boolean,
                                ByVal lev_naclo2 As Boolean, ByVal lev_k6 As Boolean, ByVal temp_max As Boolean, ByVal stop_l As Boolean,
                                                                ByVal lev_errata As Boolean, ByVal tot_Acqua As Single) As Boolean
        ...
        count_row = data_table.Count
        If count_row = 0 Then
            log_ltb_puntatore.InsertQuery(identificativo, id_strumento, data, valore_ch1, valore_ch2, valore_temperatura, flusso, lev_hcl, lev_naclo2, lev_k6, temp_max, stop_l, lev_errata, tot_Acqua)
    ...
    End Sub
    Public Function log_tower(ByVal identificativo As String, ByVal id_strumento As String, ByVal data As Date,
                            ByVal valore_ch1 As Single, ByVal valore_ch2 As Single, ByVal valore_ch3 As Single,
                            ByVal temperatura_val As Single,
                            ByVal cd_high_val As String, ByVal cd_low_val As String, ByVal bleed_timeout_val As String,
                            ByVal flow_val As String, ByVal inhib_lev_val As String, ByVal prebio1_lev_val As String, ByVal prebio2_lev_val As String,
                            ByVal bio1_lev_val As String, ByVal bio2_lev_val As String, ByVal ch2_high_val As String, ByVal ch2_low_val As String,
                            ByVal ch2_level_val As String, ByVal ch3_high_val As String, ByVal ch3_low_val As String, ByVal ch3_level_val As String,
                            ByVal tot_input_val As String, ByVal tot_bleed_val As String, ByVal out_inibitore_digital_val As String, ByVal out_inibitore_prop_val As String, ByVal out_bleed_val As String, ByVal out_prebiocide1_val As String,
                                            ByVal out_prebiocide2_val As String, ByVal out_biocide1_val As String, ByVal out_biocide2_val As String, ByVal ch2_prop_val As String, ByVal ch2_dig_val As String, ByVal ch3_prop_val As String, ByVal ch3_dig_val As String, ByVal Power_On As Boolean) As Boolean
        ...
        '                                    ch3_level_val)
        'count_row = data_table.Count
        For Each dc1 In log_tower_puntatore.GetData(identificativo, id_strumento, data,
                                             cd_high_val, cd_low_val, bleed_timeout_val, flow_val, inhib_lev_val,
                                            prebio1_lev_val, prebio2_lev_val, bio1_lev_val, bio2_lev_val, ch2_high_val, ch2_low_val, ch2_level_val, ch3_high_val, ch3_low_val,
                                            ch3_level_val)
            count_row = dc1.Expr1
            Exit For
        Next
        If count_row = 0 Then
            log_tower_puntatore.InsertQuery(identificativo, id_strumento, data, valore_ch1, valore_ch2, valore_ch3,
                                            temperatura_val, cd_high_val, cd_low_val, bleed_timeout_val, flow_val, inhib_lev_val,
                                            prebio1_lev_val, prebio2_lev_val, bio1_lev_val, bio2_lev_val, ch2_high_val, ch2_low_val, ch2_level_val, ch3_high_val, ch3_low_val,
                                            ch3_level_val, tot_input_val, tot_bleed_val,
                                            out_inibitore_digital_val, out_inibitore_prop_val, out_bleed_val, out_prebiocide1_val,
                                            out_prebiocide2_val, out_biocide1_val, out_biocide2_val, ch2_prop_val, ch2_dig_val, ch3_prop_val, ch3_dig_val, Power_On)
